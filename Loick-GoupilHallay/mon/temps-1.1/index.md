...
<div style="display: flex; flex-wrap: wrap; justify-content: center;">
  {% sizedImage "https://upload.wikimedia.org/wikipedia/commons/thumb/3/35/Tux.svg/1200px-Tux.svg.png", "Linux", "icon" %}
  {% sizedImage "https://upload.wikimedia.org/wikipedia/commons/thumb/2/22/Windows_icon.svg/256px-Windows_icon.svg.png", "Windows", "icon" %}
  {% sizedImage "https://upload.wikimedia.org/wikipedia/commons/thumb/2/22/MacOS_logo_%282017%29.svg/512px-MacOS_logo_%282017%29.svg.png", "MacOS", "icon" %}
</div>
...
<div style="display: flex; flex-wrap: wrap; justify-content: center;">
  {% sizedImage "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a5/Google_Chrome_icon_%28September_2014%29.svg/1024px-Google_Chrome_icon_%28September_2014%29.svg.png", "Google Chrome", "icon" %}
  {% sizedImage "https://upload.wikimedia.org/wikipedia/commons/thumb/7/7e/Microsoft_Edge_logo_%282019%29.png/600px-Microsoft_Edge_logo_%282019%29.png", "Microsoft Edge", "icon" %}
  {% sizedImage "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a0/Firefox_logo%2C_2019.svg/800px-Firefox_logo%2C_2019.svg.png", "Mozilla Firefox", "icon" %}
  {% sizedImage "https://upload.wikimedia.org/wikipedia/commons/thumb/5/52/Safari_browser_logo.svg/1024px-Safari_browser_logo.svg.png", "Safari", "icon" %}
</div>
...
<div style="display: flex; flex-wrap: wrap; justify-content: center;">
  {% sizedImage "https://upload.wikimedia.org/wikipedia/commons/thumb/9/9a/Visual_Studio_Code_1.35_icon.svg/langfr-1024px-Visual_Studio_Code_1.35_icon.svg.png", "Visual Studio Code", "icon" %}
  {% sizedImage "https://upload.wikimedia.org/wikipedia/commons/2/2c/Visual_Studio_Icon_2022.svg", "Visual Studio", "icon" %}
  {% sizedImage "https://upload.wikimedia.org/wikipedia/commons/9/9c/IntelliJ_IDEA_Icon.svg", "IntelliJ IDEA", "icon" %}
  {% sizedImage "https://upload.wikimedia.org/wikipedia/commons/thumb/6/69/Notepad%2B%2B_Logo.svg/langfr-120px-Notepad%2B%2B_Logo.svg.png", "Notepad++", "icon" %}
  {% sizedImage "https://upload.wikimedia.org/wikipedia/commons/thumb/9/9f/Vimlogo.svg/langfr-150px-Vimlogo.svg.png", "Vim", "icon" %}
  {% sizedImage "https://upload.wikimedia.org/wikipedia/commons/thumb/5/55/Android_Studio_Logo_%282023%29.svg/langfr-120px-Android_Studio_Logo_%282023%29.svg.png", "Android Studio", "icon" %}
</div>
...
<div style="display: flex; flex-wrap: wrap; justify-content: center;">
  {% sizedImage "https://cdn.iconscout.com/icon/free/png-256/free-java-59-1174952.png", "Java", "icon" %}
  {% sizedImage "https://upload.wikimedia.org/wikipedia/commons/1/18/ISO_C%2B%2B_Logo.svg", "C++", "icon" %}
  {% sizedImage "https://upload.wikimedia.org/wikipedia/commons/thumb/9/99/Unofficial_JavaScript_logo_2.svg/2048px-Unofficial_JavaScript_logo_2.svg.png", "JavaScript", "icon" %}
  {% sizedImage "https://raw.githubusercontent.com/docker-library/docs/01c12653951b2fe592c1f93a13b4e289ada0e3a1/python/logo.png", "Python", "icon" %}
  {% sizedImage "https://upload.wikimedia.org/wikipedia/commons/thumb/2/23/Go_Logo_Aqua.svg/1920px-Go_Logo_Aqua.svg.png", "Go", "icon" %}
  {% sizedImage "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d5/Rust_programming_language_black_logo.svg/480px-Rust_programming_language_black_logo.svg.png", "Rust", "icon" %}
  {% sizedImage "https://upload.wikimedia.org/wikipedia/commons/thumb/2/27/PHP-logo.svg/711px-PHP-logo.svg.png", "PHP", "icon" %}
</div>
...
<div style="display: flex; flex-wrap: wrap; justify-content: center;">
  {% sizedImage "https://upload.wikimedia.org/wikipedia/commons/7/70/Docker_logo.png", "Docker", "banner" %}
  {% sizedImage "https://upload.wikimedia.org/wikipedia/commons/9/9a/Podman-logo-orig.png", "Podman", "banner" %}
</div>
...
<div style="display: flex; flex-wrap: wrap; justify-content: center;">
  {% sizedImage "https://upload.wikimedia.org/wikipedia/commons/thumb/c/c9/Microsoft_Office_Teams_%282018%E2%80%93present%29.svg/langfr-110px-Microsoft_Office_Teams_%282018%E2%80%93present%29.svg.png", "Microsoft Teams", "icon" %}
  {% sizedImage "https://upload.wikimedia.org/wikipedia/commons/thumb/7/76/Slack_Icon.png/1024px-Slack_Icon.png", "Slack", "icon" %}
  {% sizedImage "https://upload.wikimedia.org/wikipedia/commons/thumb/1/11/Zoom_Logo_2022.svg/langfr-1920px-Zoom_Logo_2022.svg.png", "Zoom", "icon" %}
  {% sizedImage "https://upload.wikimedia.org/wikipedia/commons/thumb/9/9b/Google_Meet_icon_%282020%29.svg/292px-Google_Meet_icon_%282020%29.svg.png", "Google Meet", "icon" %}
  {% sizedImage "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6b/WhatsApp.svg/1024px-WhatsApp.svg.png", "WhatsApp", "icon" %}
  {% sizedImage "https://cdn.prod.website-files.com/6257adef93867e50d84d30e2/636e0a69f118df70ad7828d4_icon_clyde_blurple_RGB.svg", "Discord", "icon" %}
  {% sizedImage "https://secure.skypeassets.com/content/dam/scom/legal/brand-guidelines/skype-icon.svg", "Skype", "icon" %}
</div>
...
<div style="display: flex; flex-wrap: wrap; justify-content: center;">
  {% sizedImage "https://upload.wikimedia.org/wikipedia/commons/thumb/8/83/Telegram_2019_Logo.svg/1024px-Telegram_2019_Logo.svg.png", "Telegram", "icon" %}
  {% sizedImage "https://signal.org/brand/assets/logo_min_size.png", "Signal", "icon" %}
  {% sizedImage "https://mattermost.com/wp-content/uploads/2024/06/mattermost-logomark.svg", "Mattermost", "icon" %}
  {% sizedImage "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8f/Icons_mumble.svg/langfr-1024px-Icons_mumble.svg.png", "Mumble", "icon" %}
</div>
...
<div style="display: flex; flex-wrap: wrap; justify-content: center;">
  {% sizedImage "https://upload.wikimedia.org/wikipedia/commons/thumb/9/91/Octicons-mark-github.svg/1024px-Octicons-mark-github.svg.png", "GitHub", "icon" %}
  {% sizedImage "https://images.ctfassets.net/xz1dnu24egyd/1IRkfXmxo8VP2RAE5jiS1Q/ea2086675d87911b0ce2d34c354b3711/gitlab-logo-500.png", "GitLab", "icon" %}
  {% sizedImage "https://cdn4.iconfinder.com/data/icons/logos-and-brands/512/44_Bitbucket_logo_logos-512.png", "Bitbucket", "icon" %}
  {% sizedImage "https://www.svgrepo.com/show/448271/azure-devops.svg", "Azure Devops", "icon" %}
  {% sizedImage "https://seeklogo.com/images/S/sourceforge-logo-0372412E49-seeklogo.com.png", "SourceForge", "icon" %}
</div>
...
<div style="display: flex; flex-wrap: wrap; justify-content: center;">
  {% sizedImage "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/Jira_Software_logo.svg/1024px-Jira_Software_logo.svg.png", "Jira", "icon" %}
  {% sizedImage "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6c/Confluence-logo.svg/1024px-Confluence-logo.svg.png", "Confluence", "icon" %}
  {% sizedImage "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4d/Trello-Logo-Blue.svg/1024px-Trello-Logo-Blue.svg.png", "Trello", "icon" %}
</div>
...
<div style="display: flex; flex-wrap: wrap; justify-content: center;">
  {% sizedImage "https://cdn.prod.website-files.com/5f10ed4c0ebf7221fb5661a5/5f2af61146c55b6e172fa5b3_NexusRepo_Icon.png", "Nexus Repository", "icon" %}
  {% sizedImage "https://min.io/resources/img/logo/MINIO_Bird.png", "MinIO", "icon" %}
  {% sizedImage "https://goharbor.io/img/logos/harbor-icon-color.png", "Harbor", "icon" %}
  {% sizedImage "https://user-images.githubusercontent.com/19695083/73797283-9f75c100-477d-11ea-8ad2-ad9da73aa83d.png", "Artifactory", "icon" %}
  {% sizedImage "https://github.githubassets.com/assets/icon-integration-d8116306cd00.png", "GitHub Packages", "icon" %}
  {% sizedImage "https://avatars.githubusercontent.com/u/38353654?s=280&v=4", "Quay", "icon" %}
</div>
...
<div style="display: flex; flex-wrap: wrap; justify-content: center;">
  {% sizedImage "https://seeklogo.com/images/S/sonarqube-logo-AF25541AAF-seeklogo.com.png", "SonarQube", "icon" %}
  {% sizedImage "https://cdn.icon-icons.com/icons2/2699/PNG/512/codeclimate_logo_icon_168368.png", "CodeClimate", "icon" %}
  {% sizedImage "https://seeklogo.com/images/C/codacy-logo-1A40ABD314-seeklogo.com.png", "Codacy", "icon" %}
</div>
