...
title: "Est-ce facile de disparaître d’Internet ?"
authors:
  - "Sofiane Ouadda"
date: 2025-01-02
...
résumé: "Ce document explore la possibilité (et la difficulté) de disparaître partiellement ou totalement d’Internet. Il s’appuie sur des témoignages, notamment ceux de Frank Ahearn (expert en effacement numérique), sur une vidéo de Micode consacrée au sujet, ainsi que sur différentes ressources (RGPD, CNIL, etc.)."
...
- **Wayback Machine** ([archive.org](https://archive.org/)) : enregistre d’anciennes versions de sites, accessibles par tous.  
...
- Formulaire de déréférencement Google (pour les particuliers) :  
  - <https://support.google.com/websearch/answer/9172218?hl=fr>  
...
1. **Frank Ahearn** – *How to Disappear: Erase Your Digital Footprint, Leave False Trails, And Vanish Without A Trace*.  
2. **Micode** – “Comment disparaître d’Internet ?” (vidéo YouTube).  
3. **RGPD** – [Portail Eur-Lex](https://eur-lex.europa.eu/).  
4. **CNIL** – [cnil.fr](https://www.cnil.fr/).  
5. **Wayback Machine** – [archive.org](https://archive.org/).  
6. **JustDelete.me** – [justdelete.me](https://justdelete.me/)  
7. **Incogni** – [incogni.com](https://incogni.com/)  
8. **Privacyguides.org** – Conseils pratiques pour sécuriser sa navigation et limiter ses traces.  
9. **Autorité européenne de protection des données** – [edpb.europa.eu](https://edpb.europa.eu/) (instance de coordination RGPD).
