...
![Illustration de l'authentification](images/basic-auth-flow.webp)
...
![Authorization Code Flow](images/authorization-code-flow.webp)
...
![Un serveur proxy](images/proxy.webp)
...
![Page d'autorisation](images/authorize.webp)
